...
var UkrainianToLatin = (function () {
    ...
    UkrainianToLatin.generateLat = function generateLat(name) {
        this.initialize();
    ...
    UkrainianToLatin.checkFirstChar = function checkFirstChar(result, convertCase, nextConvertCase) {
    ...
    UkrainianToLatin.checkMiddleChar = function checkMiddleChar(result, convertCase, nextConvertCase) {
        var latName = convertCase.convert;
        switch(latName.length) {
            case UkrainianToLatin.LENGTH_2:
    ...
    UkrainianToLatin.initialize = function initialize() {
        this.cyrToLat = {
        };
